...
%     \item 
     , dependent on: 
    \begin{itemize}
      \item $\eta_{\mathrm{el},k}(\underline{r}_k)$ 
      \item and $T_\mathrm{el}$
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Anisotropic diffusion + dynamical trapping}
  ...
  \column{.4\textwidth}
    \begin{figure}
      \includegraphics[width=.9\textwidth]{figures/XYoverTime.pdf}
    \end{figure}
  \column{.6\textwidth}
    \begin{figure}
      \includegraphics[width=.9\textwidth]{figures/PES_XYview.pdf}
    \end{figure}
  \end{columns}  
\end{frame}
