...
{AG Saalfrank \\ Institut für Chemie \\ Universität Potsdam}
...
\begin{frame}{Acknowledgements}
  \begin{block}{I want to thank...}
    \begin{itemize}
     \item Peter, for all his support and particularly for writing the paper
     \item Gernot, for his amazing work on the PES
     \item Ivor, for everything GLO related 
     \item AG Saalfrank, for the pleasing atmosphere, especially ``Spa\ss{}raum 2''  
     \item Jan, and Martin K\"argell (HZB Wannsee), for some much needed help 
     \item the FHI Berlin and it's IMPRS, for my scholarship
    \end{itemize}  
  \end{block}
\end{frame}
